...
<body>
	...
	<div class="container-fluid">
		<div class="row">
				...
				<div class="sidebar-sticky">
					<ul class="nav flex-column">
						...
						<li class="nav-item"><a class="nav-link" href="#"> <span
								data-feather="users"></span> Manutenção de Usuários
						</a></li>
						<li class="nav-item"><a class="nav-link" href="#"> <span
								data-feather="bar-chart-2"></span> Relatórios
						</a></li>
					</ul>
				</div>
			</nav>
			...
			<%
				//Criando Variável tipo Usuário para rececer o usuário e senha no qual será alterado
				Usuario atualizar = new Usuario();

				//Definindo uma String usersenha que pegará o parâmetro contendo 
				//o usuário do formulário da página de manutenção de usuário.
				String userexcluir = "";

				//Caso o valor do parâmetro for diferente de vazio ele atribui este parâmetro a variável usersenha
				if (request.getParameter("usuarioexcluir") != null) {
					userexcluir = request.getParameter("usuarioexcluir");
				}

				
				//Caso as duas senhas digitadas forem iguais ele faz a troca de senhas e a alteração no BD
				//if (senha1.equals(senha2)) {
					atualizar.setUsuario(userexcluir);
					
					//Testes para ver se o parâmetro está pegando o valor correto
					//out.println(atualizar.getUsuario());
					//out.println(atualizar.getSenha());
					
					DAO_user.delete(atualizar);
				%>
					...
					<div style="margin-left:-100px; class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
						<h4 style="color:green;" class="h4">Usuário excluído com sucesso !</h4><br>
