  	...
  	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
		...
		<main role="main" class="col-md-15 ml-sm-auto col-lg-10 px-0">
			  ...
			  <%	
						...
						if(request.getParameter("senhausuario")!=null){
							usuario = request.getParameter("senhausuario");
						}	
						//out.println(usuario);
						//Usuario usuariosenha = usuariosenha.getUsuario();
					%>
			  
			  <form class="form-signin" action="alterarsenha.jsp?usuariosenha=<%=usuario%>" method="post">
				...
				<table class="table table-striped table-sm">
				  ...
				  <tbody id="invisivel_v" class="table table-striped table-sm" style="">
				  	...
				  	<tr>			  	
					 <td><%=usuario %></td>				 
					  <td><input type="password" style="width:100px;" class="form-control" id="nova_senha" name="nova_senha"></td>				  
					   <td><input type="password" style="width:100px;" class="form-control" id="confirma_senha" name="confirma_senha"></td>
